...
class LawProfile extends StatefulWidget {
  @override
  _LawProfileState createState() => _LawProfileState();
}

class _LawProfileState extends State<LawProfile> {
  final formatCurrency = new NumberFormat.simpleCurrency();

  User? admin = FirebaseAuth.instance.currentUser;
  var adminData = FirebaseFirestore.instance.collection('Lawyers');
