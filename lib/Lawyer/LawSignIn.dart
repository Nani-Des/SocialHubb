...
import 'package:virtual_council/Lawyer/LawOTSign.dart';
...
class LawSignIn extends StatefulWidget {
  @override
  _LawSignInState createState() => _LawSignInState();
}

class _LawSignInState extends State<LawSignIn> {
  ...
  Future fireSignIn() async {
    ...
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => FutureSignIn()));
  }
}
