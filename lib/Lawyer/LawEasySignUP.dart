        ...
        body: StreamBuilder<User?>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return LawEasySignUp();
              }
            }),
      );
}

class LawEasySignUp extends StatefulWidget {
  const LawEasySignUp({Key? key}) : super(key: key);

  @override
  _LawEasySignUpState createState() => _LawEasySignUpState();
}

class _LawEasySignUpState extends State<LawEasySignUp> {
